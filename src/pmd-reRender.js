  ...
  document.querySelectorAll('blockquote').forEach((QuoteElement) => {
    if (quoteproReg.test(QuoteElement.innerHTML)) {
      ...
      if (/\[i\]/.test(QuoteElement.innerHTML)) {
        QuoteElement.style.borderColor=conf.hyper_markdown.quotepro[1];
        QuoteElement.innerHTML = 
          `<p class="blockinfo" style="color: ${conf.hyper_markdown.quotepro[1]};">
          <s-icon style="color: ${conf.hyper_markdown.quotepro[1]};height: 1.2em;vertical-align: center;"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 -960 960 960"><path d="M440-280h80v-240h-80v240Zm40-320q17 0 28.5-11.5T520-640q0-17-11.5-28.5T480-680q-17 0-28.5 11.5T440-640q0 17 11.5 28.5T480-600Zm0 520q-83 0-156-31.5T197-197q-54-54-85.5-127T80-480q0-83 31.5-156T197-763q54-54 127-85.5T480-880q83 0 156 31.5T763-763q54 54 85.5 127T880-480q0 83-31.5 156T763-197q-54 54-127 85.5T480-80Zm0-80q134 0 227-93t93-227q0-134-93-227t-227-93q-134 0-227 93t-93 227q0 134 93 227t227 93Zm0-320Z"></path></svg>
          </s-icon> Info</p>`+QuoteElement.innerHTML;
      };
      if (/\[(!|！)\]/.test(QuoteElement.innerHTML)) {
        QuoteElement.style.borderColor=conf.hyper_markdown.quotepro[2];
        QuoteElement.innerHTML = 
          `<p class="blockinfo" style="color: ${conf.hyper_markdown.quotepro[2]};">
          <s-icon style="color: ${conf.hyper_markdown.quotepro[2]};height: 1.2em;vertical-align: center;"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 -960 960 960"><path d="M480-280q17 0 28.5-11.5T520-320q0-17-11.5-28.5T480-360q-17 0-28.5 11.5T440-320q0 17 11.5 28.5T480-280Zm-40-160h80v-240h-80v240Zm40 360q-83 0-156-31.5T197-197q-54-54-85.5-127T80-480q0-83 31.5-156T197-763q54-54 127-85.5T480-880q83 0 156 31.5T763-763q54 54 85.5 127T880-480q0 83-31.5 156T763-197q-54 54-127 85.5T480-80Zm0-80q134 0 227-93t93-227q0-134-93-227t-227-93q-134 0-227 93t-93 227q0 134 93 227t227 93Zm0-320Z"></path></svg>
          </s-icon> Notice</p>`+QuoteElement.innerHTML;
      };
      if (/\[x\]/.test(QuoteElement.innerHTML)) {
        QuoteElement.style.borderColor=conf.hyper_markdown.quotepro[3];
        QuoteElement.innerHTML = 
          `<p class="blockinfo" style="color: ${conf.hyper_markdown.quotepro[3]};">
          <s-icon style="color: ${conf.hyper_markdown.quotepro[3]};height: 1.2em;vertical-align: center;"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 -960 960 960"><path d="m40-120 440-760 440 760H40Zm138-80h604L480-720 178-200Zm302-40q17 0 28.5-11.5T520-280q0-17-11.5-28.5T480-320q-17 0-28.5 11.5T440-280q0 17 11.5 28.5T480-240Zm-40-120h80v-200h-80v200Zm40-100Z"></path></svg>
          </s-icon> Warn</p>`+QuoteElement.innerHTML;
      };
      if (/\[@\]/.test(QuoteElement.innerHTML)) {
        QuoteElement.style.borderColor=conf.hyper_markdown.quotepro[4];
        QuoteElement.innerHTML = 
          `<p class="blockinfo" style="color: ${conf.hyper_markdown.quotepro[4]};">
          <s-icon style="color: ${conf.hyper_markdown.quotepro[4]};height: 1.2em;vertical-align: center;"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 -960 960 960"><path d="M480-80q-83 0-156-31.5T197-197q-54-54-85.5-127T80-480q0-83 31.5-156T197-763q54-54 127-85.5T480-880q65 0 123 19t107 53l-58 59q-38-24-81-37.5T480-800q-133 0-226.5 93.5T160-480q0 133 93.5 226.5T480-160q133 0 226.5-93.5T800-480q0-18-2-36t-6-35l65-65q11 32 17 66t6 70q0 83-31.5 156T763-197q-54 54-127 85.5T480-80Zm-56-216L254-466l56-56 114 114 400-401 56 56-456 457Z"></path></svg>
